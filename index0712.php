...
<head>
    ...
    mark {
        background: linear-gradient(to top, #D1C2EB 65%, transparent 50%);
...
<body>
    ...
    <header class="header2"
        style="margin-top:3.5%; background:white; border-width:2px 0 2px 0; border-style:solid; border-color:#7f5cde; height:4.5rem;">
        <nav class="nav2 d-flex justify-content-center align-items-center">
            ...
            <div class="wrap" style="width:48rem;">
                ...
                <div class="rolling-list">
                    ...
                    <ul>
                        <li>
                            <div style="font-size:21px;font-family:Reko !important; margin-top:8px;width:40rem;">
                                지금 내가 받을 수 있는&nbsp;&nbsp;<span
            ...
            <div class="d-flex justify-content-center align-items-center" style="width:41rem;">
        ...
        <div class="slider">
            ...
            <div class="slide"
                ...
                <div class="slide-content3">
                    <div class="slide-text d-flex" style="width:100rem; margin-top:9rem;">
                        <div class="d-flex" style="width:100%; height:44rem; border-radius:50px;">
                            <div class="d-flex justify-content-between align-items-center"
                                style="border-radius:50px; background:white; width:100rem; height:44rem;">
                                <div class="bImage">
                                    <div class="d-flex">
                                        <div class="count"
                                            style="font-size:30px; font-weight:600; color:white;margin:2rem 0 0 3rem;">
                                            0
                                        </div>
                                        <div
                                            style="font-size:30px; font-weight:600; color:white;margin:2rem 0 0 .5rem;">
                                            +
                                        </div>
                                    </div>
                                ...
                                <div style="width:70rem; height:44rem;">
                                    <div class="d-flex flex-column justify-content-center align-items-start"
                                        style="width:69rem; height:45rem; margin-top:1rem;">
                                        <div style="font-size:38px; font-weight:600;letter-spacing:0px;">성공하는 기업보다는
                                            <mark class="highlighted">가치있는 기업이 되고자 노력하는</mark><br /><span
                                                style="color:#734CB7;">(주)메라클</span>이 되겠습니다.
                                        </div>
                                        <div style="margin:2.5rem 0; font-size:20px;letter-spacing:-0.5px;">
                                            고객의 도전정신,
                                            아이템의
                                            경쟁력 그리고 우리의 전문성이
                                            삼위일체가
                                            되어 여러분의 비즈니스가 지속적으로<br />성장할 수 있도록 하는것이 우리의 최우선 목표입니다.</div>
                                        <div class="d-flex flex-column justify-content-between"
                                            style="width:65rem; height:19rem;">
                                            <div class="d-flex justify-content-between">
                                                <div class="d-flex justify-content-between saupBtn"
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center align-items-start"
                                                        ...
                                                        <div style="font-size:15px;">체계적이고 맞춤화 기술경영<br />전략 및 사업화 전략을 수립
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-between saupBtn" onclick="excel()">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center align-items-start"
                                                        ...
                                                        <div style="font-size:15px;">글로벌 네트워킹을 통해 후속<br />투자 및 국내외 사업
                                                            런칭을 지원
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-between saupBtn"
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center align-items-start"
                                                        ...
                                                        <div style="font-size:15px;">테크기반 아이템의 성공적인<br />창업활동을 지원
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                                <div class="d-flex justify-content-between saupBtn"
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center align-items-start"
                                                        ...
                                                        <div style="font-size:15px;">투자유치 고객 설득을 위한<br />피칭용 IR자료를 기획 및
                                                            제작
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="d-flex justify-content-center align-items-center"
                                                        ...
                                                        <div class="d-flex justify-content-center align-items-center"
                                                            ...
                                                            <img src="./public/img/banner/BMplatform.png"
                                                                style="width:2.5rem; height:2.5rem;" alt="BM 플랫폼 솔루션">
                                                        </div>
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center align-items-start"
                                                        style="width:18rem;letter-spacing:-1px;">
                                                        <div style="font-size:22px; font-weight:600;">BM 플랫폼 솔루션</div>
                                                        <div style="font-size:15px;">창업 단계에 맞는 최적의<br />솔루션을 제공
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-between saupBtn" onclick="support()">
                                                    <div class="d-flex justify-content-center align-items-center"
                                                        style="width:8rem;">
                                                        <div class="d-flex justify-content-center align-items-center"
                                                            style="width:5rem; height:5rem; border-radius:15rem; background:white;">
                                                            <img src="./public/img/banner/support.png"
                                                                style="width:2.5rem; height:2.5rem;" alt="정부지원사업">
                                                        </div>
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center align-items-start"
                                                        style="width:18rem;letter-spacing:-1px;">
                                                        <div style="font-size:22px; font-weight:600;">정부지원사업</div>
                                                        <div style="font-size:15px;">최적화된 각종 정부지원사업과<br />연계할 수 있도록 지원
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
