                ...
                <div class="notice-board-area">
                    <div class="route">
                        <a href="/">Home</a> > <a href="../pages_en/notice.php">Communication Space</a> > <a
                            href="../pages_en/notice.php">Notice</a>
                    </div>
                    ...
                    <div class="page_num">
                        ...
                        if ($page <= 1) {
                            ...
                            $pre = $page - 1;
                            echo "<a href='/pages_en/notice.php?page=$pre'> < </a>";
                        }
                        ...
                        for ($i = $block_start; $i <= $block_end; $i++) {
                            if ($page == $i) {
                                ...
                                echo "<a href='/pages_en/notice.php?page=$i'> $i </a>";
                            }
                        }
                        ...
                        if ($page >= $total_page) {
                            ...
                            $next = $page + 1;
                            echo "<a href='/pages_en/notice.php?page=$next'> > </a>";
                        }
                        ?>
                    </div>
