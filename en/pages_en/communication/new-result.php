...
$query = "INSERT INTO tbspnews(newstitle,img_link,newslink,newstext) VALUES ('" . $newstitle . "','" . $file_name . "','" . $newslink . "','" . $newstext . "');";

if (mysqli_query($conn, $query))
    echo "<script>alert('뉴스가 정상적으로 등록되었습니다.');location.href='/en/';</script>";
else
