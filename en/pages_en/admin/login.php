...
<body>
    <div class="loginCont">
        <div class="loginwrap">
            <div class="tbspCi">
                <a href="/en"></a><img src="../../public/img/main/logo-color_merakl.png"></a>
            </div>
            <div class="login-title">
                관리자 로그인
            </div>
            <form class="login-form" method="post" action="/en/pages_en/admin/login_check.php">
            ...
            <div class="admin_join" onclick="location.href='join.php'">
