...
$proType = $_POST['project_type'];
$text = $_POST['project_people'];
$sta = $_POST['cal_s'];
$endD = $_POST['cal_e'];
...
$query = "INSERT INTO merakl_project(title,project_people,project_img,project_type,project_link,cal_s, cal_e) VALUES ('" . $title . "','" . $text . "','" . $file_name . "','" . $proType . "','" . $link . "','" . $sta . "','" . $endD . "');";

if (mysqli_query($conn, $query))
    echo "<script>alert('프로젝트가 등록되었습니다.');location.href='/pages/project.php';</script>";
else
