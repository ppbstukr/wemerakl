...
<body>
    ...
    <div class="container">
        ...
        <div class="editor-area">
            <form method="POST" action="/pages/communication/notice-result.php" enctype="multipart/form-data">
                <table>
                    <tbody>
                        <tr>
                            <th>제목</th>
                        ...
                        <tr>
                            <td colspan="4">
                                <textarea cols="150" id="editor" name="content" placeholder="내용을 입력하세요"></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
