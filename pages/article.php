                ...
                <div class="notice-board-area">
                    <div class="route">
                        <a href="/">Home</a> > <a href="../pages/notice.php">소통공간</a> > <a
                            href="../pages/article.php">Article</a>
                    </div>
                    ...
                    <div class="page_num">
                        ...
                        if ($page <= 1) {
                            ...
                            $pre = $page - 1;
                            echo "<a href='/pages/article.php?page=$pre'> < </a>";
                        }
                        ...
                        for ($i = $block_start; $i <= $block_end; $i++) {
                            if ($page == $i) {
                                ...
                                echo "<a href='/pages/article.php?page=$i'> $i </a>";
                            }
                        }
                        ...
                        if ($page >= $total_page) {
                            ...
                            $next = $page + 1;
                            echo "<a href='/pages/article.php?page=$next'> > </a>";
                        }
                        ?>
                    </div>
