...
$query = "INSERT INTO bp_board(bp_title,bp_text,bp_img,division,bp_summary) VALUES ('".$bp_title."','".$bp_text."','".$file_name."','".$division."','".$bp_summary."');";

if(mysqli_query($conn, $query))
    echo "<script>alert('포트폴리오가 등록되었습니다.');location.href='/pages/Bp.php';</script>";
else
