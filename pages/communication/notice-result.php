...
$allowed_ext = array('jpg', 'jpeg', 'png', 'gif', 'pdf', 'hwp', 'zip');
$field_name = 'myfile';
...
$query = "INSERT INTO tbnotice(title,name,content,file,division) VALUES ('" . $title . "','" . $name . "','" . $content . "','" . $file_name . "','" . $division . "');";
var_dump($query);
if (mysqli_query($conn, $query))
    echo "<script>alert('공지사항이 등록되었습니다.');location.href='/pages/communication/notice.php';</script>";
else
