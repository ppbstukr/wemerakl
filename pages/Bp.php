...
<body>
    ...
    <div class="container">
        ...
        <div class="portfolio-menu">
            ...
            <ul>
                <li>
                    <h3><a href="/pages/Bp.php?division=1"
                            class="<?php $category == 1 ? print('active') : '' ?>">창업교육</a></h3>
                </li>
                <li>
                    <h3><a href="/pages/Bp.php?division=2"
                            class="<?php $category == 2 ? print('active') : '' ?>">엑셀러레이터</a></h3>
                </li>
                <li>
                    <h3><a href="/pages/Bp.php?division=3"
                            class="<?php $category == 3 ? print('active') : '' ?>">R&D</a></h3>
                </li>
                <li>
                    <h3><a href="/pages/Bp.php?division=4"
                            class="<?php $category == 4 ? print('active') : '' ?>">IR제작</a></h3>
                </li>
                <li>
                    <h3><a href="/pages/Bp.php?division=5"
                            class="<?php $category == 5 ? print('active') : '' ?>">콘텐츠</a></h3>
                </li>
            </ul>
        </div>
        <div class="business-portfolio">
            ...
            ?>
            <div class="business-feed" onclick="location.href='/pages/bp_detail.php?id=<?php echo $value['id'] ?>'">
                <ul>
            ...
            <div class="portfolio-write">
                ...
                ?>
                <button class="new-portfolio" onclick="location.href='/pages/bp_write.php'">
                    <b>포트폴리오 등록</b>
                </button>
                <?php
                }
