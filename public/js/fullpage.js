...
! function (n, t) {
    ...
    var kt = function (n) {
        ...
        jt = function (n, t) {
            this.parent = this.parent || null, this.selector = t, this.anchor = U(n, "data-anchor") || Tt().anchors[A(n, Tt().sectionSelector)], this.item = n, this.isVisible = d(n), this.isActive = m(n, Kn), this.un = m(n, at) || null != p(ut, n)[0], this.ln = t === Tt().sectionSelector, this.cn = F(n, ot) || F(n, Hn), this.index = function () {
    ...
    jt.prototype.siblings = function () {
        return this.ln ? this.isVisible ? dn.F : dn.sn : this.parent ? this.parent.slides : 0
    ...
    function Wt(n, t) {
        t ? It(St()) : Bt(St()), clearTimeout(Dt), y(St(), Ht(n)), f.test.hn = n, Dt = setTimeout((function () {
            D(St(), Vn)
        }), 10)
    }
    ...
    function Yt(n, t, e, i) {
        ...
        hn({
            ...
            if (dn.q) {
                var v = t;
                e && (v = o.fp_easings[Tt().easing](s, a, u, e)), s <= e && Ft(n, v), s < e ? window.requestAnimationFrame(_t) : void 0 === i || l || (i(), hn({
                    q: !1
                }), l = !0)
            } else l || c || (i(), hn({
                q: !1
            ...
            if (!(pn().I.item == i && !dn.V || Tt().scrollBar && H() === u.dtop && !m(i, "fp-auto-height"))) {
                ...
                Tt().autoScrolling && Tt().continuousVertical && void 0 !== u.isMovementUp && (!u.isMovementUp && "up" == u.yMovement || u.isMovementUp && "down" == u.yMovement) && (u = function (n) {
                        ...
                        return n.isMovementUp ? N(t, tn(t, $n)) : I(t, en(t, $n).reverse()), Vt(pn().I.item.offsetTop),
                            ...
                            }(), n.gn = t, n.dtop = n.element.offsetTop, n.yMovement = Nt(pn().I, n.element), n
    ...
    function Oe(n) {
        hn({
            ...
            function (n) {
                null != n.gn && (n.isMovementUp ? N(p($n)[0], n.gn) : I(p($n)[pn().F.length - 1], n.gn), Vt(pn().I.item.offsetTop), function () {
                    for (var n = p(nt), t = 0; t < n.length; t++) Ge(n[t], "internal")
                }(), hn({
                    on: !1
                }))
                ...
                G: !0
            }), vn.R(zn, n), Y(n.callback) && n.callback()
    }
    ...
    function ze(n) {
        Tt().verticalCentered && (!Tt().scrollOverflow && Ve.wn(n.item) || Ve.bn(n) || m(n.item, rt) || L(n.item, rt))
    }
    ...
    function Ie(n) {
        var t = n.item,
            e = n.yn.length,
            i = n.index();
        !pn().I && n.isVisible && (L(t, Kn), Qe(), Fe = pn().I.item), Tt().paddingTop && y(t, {
        ...
        }), void 0 !== Tt().anchors[i] && t.setAttribute("data-anchor", n.anchor), e || ze(n)
    }
    ...
    f.getActiveSection = function () {
        ...
        vn.D(gn, Ne), vn.D(Pn, Ve.onLeave), vn.D(Rn, Ve.onLeave), vn.D(Cn, Ve.afterLoad), vn.D(zn, Ve.afterLoad), vn.D(Tn, Be), _("keyup", Ve.Mn)
    }));
    var He, We, Ve = {
        An: null,
        xn: !0,
        ...
        Dn: function (n) {
            if (!cn() && Tt().keyboardScrolling && [38, 33, 32, 40, 34, 36, 35].indexOf(n.keyCode) > -1 && !Ve.kn) return V(n), !1
        },
        Mn: function () {
            Ve.xn = dn.G
        },
        ...
        afterLoad: function () {
            Ve.kn = !1, clearTimeout(Ce), Ce = setTimeout((function () {
                Ve.xn = dn.G
            }), 200)
        },
        En: function () {
        ...
        Tn: function () {
            if (Tt().scrollOverflow && Ve.xn) {
                ...
                !n || a || l || (this.An = n, requestAnimationFrame((function () {
                    n.focus(), Ve.kn = !0
                }))), Ve.xn = !1
            }
        },
        Sn: function () {
            Tt().scrollOverflowMacStyle && !u && L(Kt, "fp-scroll-mac"), pn().dn.forEach((function (n) {
        ...
        zn: function (n) {
            Ve.Rn(n).addEventListener("scroll", Ve.Cn), n.addEventListener("wheel", Ve.Ln, {
                passive: !1
            }), n.addEventListener("keydown", Ve.Dn, {
                passive: !1
            })
        },
        Pn: function (n) {
        ...
        Cn: (He = 0, function (n) {
            ...
            He = t, Y(Tt().onScrollOverflow) && Xt("onScrollOverflow", {
                position: t,
                direction: e
            }), m(n.target, at) && dn.G && Ve.In(e, n.target) && Ve.Nn() && Ve.wn(pn().I.item) && vn.R(An, {
                direction: e
            })
        })
    };
    ...
    function Qe() {
        dn.I = null, dn.F.map((function (n) {
                var t = m(n.item, Kn);
                n.isActive = t, n.un = Ve.un(n.item), t && (dn.I = n), n.slides.length && (n.activeSlide = null, n.slides.map((function (t) {
                    var e = m(t.item, Kn);
                    t.un = Ve.un(n.item), t.isActive = e, e && (n.activeSlide = t)
                })))
            })),
            function () {
                var n = dn.I,
    ...
    function Xe() {
        ...
        Ye = Je(dn.I), $e = Je(dn.I ? dn.I.activeSlide : null), dn.P = t.length, dn.C = i.reduce((function (n, t) {
            return n + t.slides.length
        }), 0), dn.F = i, dn.sn = e, dn.slides = o, dn.dn = dn.F.concat(dn.slides)
    }
    ...
    var ni = function (n) {
        var t = this;
        [].push.call(arguments, Tt().sectionSelector), jt.apply(this, arguments), this.yn = p(Tt().slideSelector, n), this.Wn = Array.from(this.yn).map((function (n) {
            return new ei(n, t)
    ...
    function ui(n) {
        var t = ai();
        (ai() || h(p(Tt().sectionSelector, St())).length !== pn().P) && !dn.on && (Tt().observer && ti && ti.disconnect(), Xe(), Qe(), Tt().anchors = [], Z(p(Xn)), ii(), xt(), Tt().navigation && ge(), t && (Z(p(ct)), Z(p(vt))), pn().F.forEach((function (n) {
    ...
    function pi() {
        var n = Tt().css3 ? H() + w() : rn(pn().F).item.offsetTop + rn(pn().F).item.offsetHeight,
            t = Ct(n);
        f.test.top = -n + "px", hn({
            G: !1
    ...
    function Ti() {
        var n = pn().I.next();
        n || !Tt().loopBottom && !Tt().continuousVertical || (n = pn().F[0]), null != n ? je(n, null, !1) : St().scrollHeight < Kt.scrollHeight && vn.R(Dn)
    }

    function Mi() {
        var n = pn().I.prev();
        n || !Tt().loopTop && !Tt().continuousVertical || (n = rn(pn().F)), null != n && je(n, null, !0)
    }
    ...
    function ki(n) {
        if (fe().m[n]) {
            var t = "down" === n ? Ti : Mi;
            Tt().scrollOverflow && Ve.bn(pn().I) ? Ve.In(n, pn().I.item) && Ve.Nn() && t() : t()
        }
    }
    ...
    function Ii(n) {
        ...
        if (Ni(n)) {
            ...
            var r = Math.abs(Ei - Pi) > o.innerHeight / 100 * Tt().touchSensitivity,
                ...
                l = Ei > Pi ? "down" : "up";
            hn({
                Y: u ? Ri > zi ? "right" : "left" : l
            }), u ? !dn.W && a && (Ri > zi ? fe().m.right && vn.R(bn, {
                section: t
            }) : fe().m.left && vn.R(wn, {
                section: t
    ...
    function Yi(n, t) {
        ...
        if (null != e) {
            ...
            e.anchor === dn._ || m(e.item, Kn) ? Gi(i) : je(e, (function () {
                Gi(i)
            }))
        }
    }
        ...
        9 === t ? function (n) {
                ...
                if (l || !t && u) {
                    ...
                    var c = function (n) {
                            var t, e = n ? "prevPanel" : "nextPanel",
                                i = [],
                                o = zt((dn.I && dn.I.activeSlide ? dn.I.activeSlide : dn.I)[e]());
                            do {
            ...
            ! function (n) {
                ...
                if (function (n) {
                        ...
                        })(n) && !F(n.target, ut) && n.preventDefault()
                    }(n), dn.G || u) switch (hn({
                    N: "keydown"
                }), n.keyCode) {
                    case 38:
    ...
    f.moveSlideLeft = _i, f.moveSlideRight = Ki, f.moveTo = $i, vn.D(Sn, (function () {
        K("blur", Zi), _("keydown", Xi), _("keyup", Ji), vn.D(Tn, Qi), vn.D(Cn, no), vn.D(zn, to)
    }));
        ...
        var t = (new Date).getTime(),
            ...
            i = function (n, t) {
                ...
                if (pn().B) {
                    if (e) {
                        var o;
                        if (!(i || Si("isNewKeyframe", "beyondFullpage") && hi.Un())) return (o = Ct(rn(pn().F).item.offsetTop + rn(pn().F).item.offsetHeight)).element.scrollTo(0, o.options), hn({
                            Kn: !1
                        }), V(t), !1;
    ...
    function fo(n) {
        n ? (ao(!0), function () {
            if (Fi.qn && (a || l)) {
                Tt().autoScrolling && (Kt.removeEventListener(Fi.qn, Vi, {
                    passive: !1
                }), Kt.addEventListener(Fi.qn, Vi, {
                    passive: !1
                }));
                var n = Tt().touchWrapper;
                n.removeEventListener(Fi.Gn, Bi), n.removeEventListener(Fi.qn, Ii, {
                    passive: !1
                }), n.addEventListener(Fi.Gn, Bi), n.addEventListener(Fi.qn, Ii, {
                    passive: !1
                })
            }
        }()) : (ao(!1), function () {
            if (Fi.qn && (a || l)) {
                Tt().autoScrolling && (Kt.removeEventListener(Fi.qn, Ii, {
                    passive: !1
                }), Kt.removeEventListener(Fi.qn, Vi, {
                    passive: !1
                }));
                var n = Tt().touchWrapper;
                n.removeEventListener(Fi.Gn, Bi), n.removeEventListener(Fi.qn, Ii, {
    ...
    function Eo(n) {
        var t = n.target;
        t && F(t, "#fp-nav a") ? me.call(t, n.e) : Q(t, ".fp-tooltip") ? pe.call(t) : (Q(t, ft) || null != F(t, ft)) && ue.call(t, n.e)
    }
    ...
    function Co(n) {
        var t, e, i, o, r;
        if (!dn.V && pn().I && (rn(pn().F), !pn().B && !pn().Kn && (!Tt().autoScrolling || Tt().scrollBar))) {
            var a = H(),
                u = function (n) {
                    var t = n > zo ? "down" : "up";
                    return zo = n, hn({
    ...
    function Io(n) {
        var t = n.index();
        void 0 !== Tt().anchors[t] && n.isActive && we(Tt().anchors[t], t), Tt().menu && Tt().css3 && null != F(p(Tt().menu)[0], Hn) && p(Tt().menu).forEach((function (n) {
            Kt.appendChild(n)
        }))
    }
    ...
    function No() {
        var n, t, e = pn().I,
            i = pn().I.item;
        L(i, Gn), te(i), he(), Jt(i), t = qi((n = ko()).section), n.section && t && (void 0 === t || t.index() !== A(Fe)) || !Y(Tt().afterLoad) || Xt("afterLoad", {
            I: i,
            element: i,
            direction: null,
            anchorLink: e.anchor,
        ...
        Xe(), Qe(), Tt().scrollBar = Tt().scrollBar || Tt().hybrid, xt(),
            function () {
                ...
                for (var n = pn().sn, t = 0; t < n.length; t++) {
                    var e = n[t],
                        i = e.yn;
                    e.item.setAttribute("data-fp-styles", U(e.item, "style")), Ie(e), Io(e), i.length > 0 && oi(e)
                }
    ...
    function Uo(n, t) {
        ...
        if (Kt = p("body")[0], qt = p("html")[0], Gt = p("html, body"), !m(qt, _n)) return "touchWrapper", e = "string" == typeof n ? p(n)[0] : n, gt.touchWrapper = e,
            ...
            }, f.version = "4.0.19", f.test = Object.assign(f.test, {
                top: "0px",
    ...
    return vn.D(Tn, (function () {
            ...
            K("scroll", Co), r.body.addEventListener("scroll", Co), vn.D(xn, (function (n) {
        ...
        }(), f.setKeyboardScrolling = Fo, f.shared.nt = No, f.setAllowScrolling = Bo, f.destroy = function (n) {
            de(!1, "internal"), Bo(!0), fo(!1), Fo(!1), L(St(), Un), vn.R(Tn), n && (Vt(0), p("img[data-src], source[data-src], audio[data-src], iframe[data-src]", St()).forEach((function (n) {
                un(n, "src")
            })), p("img[data-srcset]").forEach((function (n) {
                un(n, "srcset")
            })), Z(p("#fp-nav, .fp-slidesNav, .fp-controlArrow")), y(Ot(pn().F), {
                height: "",
                "background-color": "",
                padding: ""
            }), y(Ot(pn().slides), {
                ...
                overflow: "",
                height: ""
            }), D(qt, _n), D(Kt, Wn), Kt.className.split(/\s+/).forEach((function (n) {
                0 === n.indexOf("fp-viewing") && D(Kt, n)
            })), Ot(pn().dn).forEach((function (n) {
                Tt().scrollOverflow && Ve.Fn(n), D(n, "fp-table active " + Gn), U(n, "data-fp-styles") && n.setAttribute("style", U(n, "data-fp-styles")), m(n, Yn) && !wt && n.removeAttribute("data-anchor")
